...
class Manager:
    ...
    def evaluate_indexed(self, parameters: list[float], indices: list[int]) -> list[float]: ...
    def par_evaluate(self, parameters: list[float]) -> list[float]: ...
    def par_evaluate_indexed(self, parameters: list[float], indices: list[int]) -> list[float]: ...
    def fix(self, amplitude_1: str, parameter_1: str, value: float) -> None: ...
    def free(self, amplitude_1: str, parameter_1: str) -> None: ...
    def set_bounds(
        self, amplitude_1: str, parameter_1: str, bounds: tuple[float, float]
...
class ExtendedLogLikelihood:
    ...
    def evaluate_indexed(
        self, parameters: list[float], indices_data: list[int], indices_mc: list[int]
    ) -> float: ...
    def par_evaluate(self, parameters: list[float], *, num_threads: int = 1) -> float: ...
    def par_evaluate_indexed(
        self,
    ...
    def intensity(self, parameters: list[float], dataset_mc: Dataset) -> list[float]: ...
    def intensity_indexed(
        self,
        parameters: list[float],
        indices_data: list[int],
        dataset_mc: Dataset,
    ...
    def par_intensity(
        self, parameters: list[float], dataset_mc: Dataset, *, num_threads: int = 1
    ) -> list[float]: ...
    def par_intensity_indexed(
        self,
        parameters: list[float],
        indices_data: list[int],
        dataset_mc: Dataset,
