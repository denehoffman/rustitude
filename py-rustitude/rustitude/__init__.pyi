...
class Amplitude_64:
    ...
    def as_cohsum(self) -> CohSum_64: ...
    def real(self) -> Real_64: ...
    def imag(self) -> Imag_64: ...
    def __add__(self, other: Self | Real_64 | Imag_64 | Product_64 | CohSum_64) -> CohSum_64: ...
    @overload
    def __mul__(self, other: Self | Real_64 | Imag_64 | Product_64) -> Product_64: ...
    @overload
    def __mul__(self, other: CohSum_64) -> CohSum_64: ...
...
class Amplitude_32:
    ...
    def as_cohsum(self) -> CohSum_32: ...
    def real(self) -> Real_32: ...
    def imag(self) -> Imag_32: ...
    def __add__(self, other: Self | Real_32 | Imag_32 | Product_32 | CohSum_32) -> CohSum_32: ...
    @overload
    def __mul__(self, other: Self | Real_32 | Imag_32 | Product_32) -> Product_32: ...
    @overload
    def __mul__(self, other: CohSum_32) -> CohSum_32: ...
...
class CohSum_64:
    def __init__(
        self, terms: list[Amplitude_64 | Real_64 | Imag_64 | Product_64 | CohSum_64]
    ) -> None: ...
    def __add__(self, other: Self | Amplitude_64 | Real_64 | Imag_64 | Product_64) -> Self: ...
    def __mul__(self, other: Amplitude_64 | Real_64 | Imag_64 | Product_64) -> CohSum_64: ...

class CohSum_32:
    def __init__(
        self, terms: list[Amplitude_32 | Real_32 | Imag_32 | Product_32 | CohSum_32]
    ) -> None: ...
    def __add__(self, other: Self | Amplitude_32 | Real_32 | Imag_32 | Product_32) -> Self: ...
    def __mul__(self, other: Amplitude_32 | Real_32 | Imag_32 | Product_32) -> CohSum_32: ...
...
class Model_64:
    ...
    def __init__(self, cohsums: list[CohSum_64]) -> None: ...
...
class Model_32:
    ...
    def __init__(self, cohsums: list[CohSum_32]) -> None: ...
